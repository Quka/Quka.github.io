...
var Login = /** @class */ (function () {
    ...
    Login.prototype.Authenticate = function (uri, username, password) {
        var _this = this;
        var promise = _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(uri + "/username/" + username)
            ...
            if (response.status == 200) {
                ...
                if (username.toLowerCase() == (profileData.firstName).toLowerCase()
                    && password == "test1234") {
                    _this.loggedInProfile = profileData;
                    return true;
                }
                else {
                    return false;
...
/***/ "./src/js/Views/CreateProfilePage.ts":
/*!*******************************************!*\
  !*** ./src/js/Views/CreateProfilePage.ts ***!
  \*******************************************/
...
var CreateProfilePage = /** @class */ (function () {
     ...
     *
     */
    function CreateProfilePage(uri) {
        this.uri = uri;
    }
    CreateProfilePage.prototype.getPage = function (parentHtml) {
        var _this = this;
        ...
        var profileFirstnameArea = document.createElement("div");
        profileFirstnameArea.innerHTML = "Fornavn: ";
        var profileFirstnameInput = document.createElement("input");
        profileFirstnameInput.id = "createFirstname";
        profileFirstnameArea.appendChild(profileFirstnameInput);
        var profileLastnameArea = document.createElement("div");
        profileLastnameArea.innerHTML = "Efternavn: ";
        var profileLastnameInput = document.createElement("input");
        profileLastnameInput.id = "createLastname";
        profileLastnameArea.appendChild(profileLastnameInput);
        var profileBirthdayArea = document.createElement("div");
        profileBirthdayArea.innerHTML = "Fødselsdato: ";
        var profileBirthdayInput = document.createElement("input");
        ...
        var profileWeightArea = document.createElement("div");
        profileWeightArea.innerHTML = "Vægt: ";
        var profileWeightInput = document.createElement("input");
        profileWeightInput.id = "createWeight";
        profileWeightArea.appendChild(profileWeightInput);
        var profileHeightArea = document.createElement("div");
        profileHeightArea.innerHTML = "Højde: ";
        var profileHeightInput = document.createElement("input");
        ...
        var CreateProfileBtn = document.createElement("button");
        ...
        CreateProfileBtn.addEventListener('click', function () {
            _this.createProfile(_this.uri);
        });
        return parentHtml;
    };
    CreateProfilePage.prototype.createProfile = function (uri) {
        ...
        var createBirthday = new Date(document.getElementById("createBirthday").value);
        var createWeight = Number(document.getElementById("createWeight").value);
        var createHeight = Number(document.getElementById("createHeight").value);
        var newProfile = {
        ...
        _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(uri, newProfile)
            .then(function (response) {
...
var ProfilePage = /** @class */ (function () {
     ...
     *
     */
    function ProfilePage(uri, login) {
        this.uri = uri;
        this.login = login;
    }
    ProfilePage.prototype.getPage = function (parentHtml) {
        var _this = this;
        // Empty the parent html page
        parentHtml.innerHTML = "";
         ...
         */
        var profileInfoWrapper = document.createElement("div");
        ...
        var profileInfoBirthday = document.createElement("div");
        ...
        var profileInfoHeight = document.createElement("div");
        ...
        var profileInfoWeight = document.createElement("div");
        ...
        // User profile STEPS
        var profileInfoStepsTitle = document.createElement("h3");
        profileInfoStepsTitle.innerHTML = "Dine skridt";
        profileInfoWrapper.appendChild(profileInfoStepsTitle);
        var profileInfoSteps = document.createElement("ul");
        this.login.loggedInProfile.steps.forEach(function (step) {
        ...
        editProfileBtn.addEventListener('click', function () {
            parentHtml.appendChild(_this.getEditProfileBox());
        });
        deleteProfileBtn.addEventListener('click', function () {
            _this.deleteProfile(_this.uri, _this.login.loggedInProfile.id)
                .then(function (resp) {
                if (resp) {
                    window.location.reload();
                }
    ...
    ProfilePage.prototype.getEditProfileBox = function () {
        var _this = this;
        ...
        var profileInfoFirstname = document.createElement("label");
        profileInfoFirstname.innerHTML = "<p>Fornavn: </p> ";
        var profileInfoFirstnameInput = document.createElement("input");
        ...
        var profileInfoLastname = document.createElement("label");
        profileInfoLastname.innerHTML = "<p>Efternavn: </p> ";
        var profileInfoLastnameInput = document.createElement("input");
        ...
        var profileInfoBirthday = document.createElement("label");
        profileInfoBirthday.innerHTML = "<p>Fødselsdag: </p> ";
        var profileInfoBirthdayInput = document.createElement("input");
        ...
        profileInfo.appendChild(profileInfoBirthday);
        var profileInfoWeight = document.createElement("label");
        profileInfoWeight.innerHTML = "<p>Vægt: </p> ";
        var profileInfoWeightInput = document.createElement("input");
        ...
        profileInfo.appendChild(profileInfoWeight);
        var profileInfoHeight = document.createElement("label");
        profileInfoHeight.innerHTML = "<p>Højde: </p> ";
        var profileInfoHeightInput = document.createElement("input");
        ...
        profileInfo.appendChild(profileInfoHeight);
        var profileSaveBtn = document.createElement("button");
        ...
        profileSaveBtn.addEventListener('click', function () {
            _this.updateProfile(_this.uri, _this.login.loggedInProfile.id)
                .then(function (response) {
                console.log(response);
                if (response) {
                    window.location.reload();
        ...
        var profileCloseBtn = document.createElement("button");
    ...
    ProfilePage.prototype.updateProfile = function (uri, id) {
        var _this = this;
        var firstNameVal = document.getElementById("editFirstname").value;
        var lastNameVal = document.getElementById("editLastname").value;
        var birthdayVal = new Date((document.getElementById("editBirthdate").value));
        var weightVal = Number(document.getElementById("editWeight").value);
        var heightVal = Number(document.getElementById("editHeight").value);
        var p = {
            id: id,
        ...
        var promise = _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.put(uri + id, p)
            .then(function (response) {
            if (response.status == 200) {
                var profileId = response.data;
                if (profileId == p.id) {
                    _this.login.loggedInProfile = p;
                    return true;
                }
            }
            return false;
    ...
    ProfilePage.prototype.deleteProfile = function (uri, id) {
        var _this = this;
        var conf = confirm("Sikker på du vil slette din konto?");
        if (!conf) {
            return Promise.resolve(false);
        }
        var promise = _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(uri + id)
            .then(function (response) {
            console.log(response);
            if (response.data == _this.login.loggedInProfile.id) {
                return true;
            }
            return false;
        })
    ...
    // BMI calculator
    ProfilePage.prototype.calculateBMI = function (weight, height) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Login__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Login */ "./src/js/Login.ts");
/* harmony import */ var _Views_ProfilePage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Views/ProfilePage */ "./src/js/Views/ProfilePage.ts");
/* harmony import */ var _Views_CreateProfilePage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Views/CreateProfilePage */ "./src/js/Views/CreateProfilePage.ts");



// URL to our online webservice
var uri = "https://motionsberegnerrestservice20181203104407.azurewebsites.net/api/profile/";
// Declare global login variable
var login = new _Login__WEBPACK_IMPORTED_MODULE_0__["Login"]();
var pProfile; // Is initialized when user is authenticated (below)
var pCreateProfile = new _Views_CreateProfilePage__WEBPACK_IMPORTED_MODULE_2__["CreateProfilePage"](uri);
...
loginBtn.addEventListener('click', function () {
    ...
    login.Authenticate(uri, loginUsername, loginPassword)
        .then(function (response) {
        if (response) {
            pProfile = new _Views_ProfilePage__WEBPACK_IMPORTED_MODULE_1__["ProfilePage"](uri, login);
            changePage(pProfile.getPage(element));
        }
        else {
...
var CreateProfilePageButton = document.getElementById("createProfilePageButton");
CreateProfilePageButton.addEventListener('click', function () {
    changePage(pCreateProfile.getPage(element));
});
...
/***/ 0:
/*!*********************************************************************!*\
  !*** multi ./src/index.htm ./src/css/styles.scss ./src/js/index.ts ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
